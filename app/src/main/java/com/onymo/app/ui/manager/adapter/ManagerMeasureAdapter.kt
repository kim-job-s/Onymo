...
class ManagerMeasureAdapter(
...
) : RecyclerView.Adapter<ManagerMeasureAdapter.OutlineViewHolder>() {
    ...
    inner class OutlineViewHolder(private val binding: ItemManagerMeasureOutlineBinding) :
        ...
        fun bind(outline: MeasureItem) {
            ...
            // 내부 RecyclerView 설정
            val innerAdapter = MeasureTextAdapter(innerItemsProvider(outline.id))
